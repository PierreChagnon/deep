    ...
    const completion = await openai.chat.completions.create({
        messages: [
            ...
            },
            {
                ...
                \n\nParticipants scoring low out of 7 dislike this dimension, while those scoring high enjoy it. 
                Create a one-paragraph, 150-word personalized summary of the gamer's personality, addressing the gamer directly. Avoid segregation by dimensions or explicit mention of scores. Use a capital letter for the four dimensions. Contrast their profile with gamers who have different scores. Extrapolate specific insights into their preferences for very specific game mechanics, design, format, and genres, using game-specific terminology. Include things they should like and not like. Include distinctive details to enhance personalization. Use a simple, straightforward, science-y style, without pompous words. Conclude with 'Your gaming persona is one of...' summarizing everything in under 20 words.`
            },
        ],
        model: "gpt-4o",
    });
