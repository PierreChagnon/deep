...
export default function Home() {
  ...
  return (
    ...
    <motion.main
      ...
      <motion.h1
        variants={item}
        className='h-44 lg:h-56 3xl:h-96 mb-44 relative mx-12 md:mx-28 2xl:mx-32 flex justify-center items-center'>
        <Image src="/assets/title.png" fill={true} alt="DEEP" objectFit='contain' />
      </motion.h1>
      <motion.div
        variants={item}
        className={`${bungee.className} flex px-16 justify-center justify-items-center text-center text-sm md:text-2xl 2xl:text-3xl 3xl:text-4xl text-white`}>
