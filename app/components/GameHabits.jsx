        ...
        <div className='flex flex-col mb-4'>
            ...
            <div className='p-[2px] mb-10 max-w-xs rounded-md from-[#7944F0] via-[#ED5C8A] to-[#FF922A] bg-gradient-to-r flex justify-center items-center'>
                <input onChange={(e) => {
                    ...
                    placeholder='0' value={numberOfGames} type="number" className='h-full w-full bg-[#010018] py-2 px-2 rounded-md' />
            </div>
            ...
            <div className='p-[2px] mb-10 max-w-xs rounded-md from-[#7944F0] via-[#ED5C8A] to-[#FF922A] bg-gradient-to-r flex justify-center items-center'>
                <input onChange={(e) => {
                    ...
                    placeholder='0' value={gamesPerWeek} type="number" className='h-full w-full bg-[#010018] py-2 px-2 rounded-md' />
            </div>
