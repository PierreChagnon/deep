        ...
        <main className='text-white flex flex-col justify-between min-h-dvh relative md:px-8 lg:px-12'>
            <div className="flex flex-1 flex-col items-center px-8 gap-8 mb-8 md:overflow-hidden">
                ...
                <div className='flex flex-col px-2 2xl:px-32 3xl:px-96 items-center gap-4'>
                    ...
                    <p className='3xl:text-xl '>Before we look at what analyzes the DEEP model allows us to carry out, let's ask a fundamental question: How do we calculate a score for each gamer on each dimension? Psychologists have developed a tool called ‘<strong>psychometric scales</strong>’. These scales are designed to measure <strong>habits</strong>, <strong>preferences</strong> and <strong>tendencies</strong> in a consistent and reliable way. The reasoning is simple but powerful: by quantifying habits or preferences, we can better understand patterns and correlations in human behavior. For example, to measure how much a person enjoys ‘Discovering’ in games, we might ask them to rate statements such as "<em>I like discovering new places</em>" on a scale from “strongly disagree” to “strongly agree”. These ratings are then used to calculate their score in the ‘Discovering’ dimension.</p>
