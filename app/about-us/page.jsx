            ...
            <div className='flex flex-col items-center justify-center gap-8 px-2 md:px-28 2xl:px-32 3xl:px-96'>
                ...
                <div className='flex flex-col md:flex-row justify-between items-center gap-8 mt-8 mb-8'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <Link className='flex underline gap-4 items-center' target='blank' href="https://sites.google.com/site/chambonvalerian/home"><TbWorld className='text-2xl' />https://sites.google.com/site/chambonvalerian/home<FiExternalLink className='text-xl' /></Link>
                ...
                <div className='flex flex-col md:flex-row justify-between items-center gap-8 mt-8 mb-8'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <Link className='flex underline gap-4 items-center' target='blank' href="https://www.edgardubourg.fr"><TbWorld className='text-2xl' />www.edgardubourg.fr<FiExternalLink className='text-xl' /></Link>
