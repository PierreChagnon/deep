...
export default function page() {
    return (
        <main className='text-white flex flex-col items-center justify-between min-h-dvh relative px-2'>
            <div className='flex flex-col justify-center items-center gap-8 px-4 3xl:text-xl md:px-28 2xl:px-32 3xl:px-96'>
                <h1 className={`${bungee.className} text-center text-3xl mb-8 3xl:text-4xl`}>Researcher area</h1>
                <p className='3xl:text-xl mb-12 lg:w-2/3' >This dedicated space provides resources for exploring the DEEP model, a new
                ...
                <div className='flex items-center w-full flex-col gap-4 md:flex-row lg:w-2/3 rounded-md bg-white/10 p-6 self-center justify-between'>
                    <Link target='blank' href="https://osf.io/eyn8u/" className='flex gap-2 items-center cursor-pointer hover:opacity-50 duration-200'>
                        <span className='text-3xl text-red-400'><TbWorld /></span>
                        <button className='underline flex items-center gap-1'>Consult the data repository<FiExternalLink className='text-xl' /></button>
                    </Link>
                    <p className='md:w-1/2'>OSF page where you can find <strong>the datasets and R scripts</strong>.</p>
                </div>
                <div className='flex items-center w-full flex-col gap-4 md:flex-row lg:w-2/3 rounded-md bg-white/10 p-6 self-center justify-between'>
                    <Link target='blank' href="https://www.frontiersin.org/articles/10.3389/frai.2024.1365508/full" className='flex gap-2 items-center cursor-pointer hover:opacity-50 duration-200'>
                        <span className='text-3xl text-red-400'><TbWorld /></span>
                        <button className='underline flex items-center gap-1 truncate'>Read the Method article<FiExternalLink className='text-xl' /></button>
                    </Link>
                ...
                <p className='mt-12 3xl:text-xl mb-12 lg:w-2/3'>As you engage with the DEEP model and its associated resources, we welcome your
