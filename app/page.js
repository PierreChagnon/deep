...
export default function Home() {
  ...
  return (
    ...
    <main onClick={() => router.push("/home")} className="h-dvh hover:cursor-pointer flex flex-col bg-center overflow-hidden">
      <h1 className='flex-1 relative mx-12 md:mx-28 flex justify-center items-center'>
        <Image src="/assets/title.png" fill={true} alt="DEEP" objectFit='contain' />
      </h1>
      <div className={`${bungee.className} flex justify-center justify-items-center text-center text-sm md:text-2xl py-8 px-2 md:px-4 text-white`}>
        <span>Dive</span>
